...
1. **Start the project from template using [Flotiq CLI]((https://github.com/flotiq/flotiq-cli))**
   ...
   flotiq start [projectName] https://github.com/flotiq/flotiq-gatsby-portfolio-2.git [flotiqApiKey] 
    ```
...
5. **Open the source code and start editing!**
    ...
    Open the `flotiq-gatsby-portfolio-2` directory in your code editor of choice and edit `src/templates/index.js`. Save your changes and the browser will update in real time!
...
[<img src="https://www.gatsbyjs.com/deploynow.svg" alt="Deploy to Gatsby Cloud">](https://www.gatsbyjs.com/dashboard/deploynow?url=https://github.com/flotiq/flotiq-gatsby-portfolio-2)
