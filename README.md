...
Live Demo: https://flotiq-gatsby-portfolio-2.netlify.app
...
Open the `flotiq-gatsby-portfolio-2` directory in your code editor of choice and edit `src/templates/index.js`.
